...
public class LeadNotFoundException extends RuntimeException {
    ...
    public LeadNotFoundException(ErrorCodes errorCodes, HttpStatus httpStatus) {
    ...
    public LeadNotFoundException(String message, HttpStatus status, ErrorCodes errorCodes, String message1, ErrorCodeResponse errorCodeResponse) {
        super(message);
        this.status = status;
        this.errorCodes = errorCodes;
    ...
    public LeadNotFoundException(HttpStatus status, ErrorCodes errorCodes) {
        this.status = status;
        this.errorCodes = errorCodes;
    }
}
